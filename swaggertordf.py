...
"""
    ...
    <owl:ObjectProperty rdf:about="{prop_uri}">
        ...
        <rdfs:domain rdf:resource="{class_uri}"/>
        <rdfs:range rdf:resource="{self.base_uri}{req_body_id}"/>
    </owl:ObjectProperty>
"""
                    classes_output += prop_def
...
"""
    ...
    """
            ...
            belongs_to_prop = "belongsToEndpoint"
            if belongs_to_prop not in self.object_properties:
                self.object_properties.add(belongs_to_prop)
                prop_uri = f"{self.base_uri}{belongs_to_prop}"
